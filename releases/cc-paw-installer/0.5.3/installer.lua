...
function ccpaw.install(pkgName, version)
  local root, pkgVersion = "https://cc-paw.github.io/cc-paw/releases/", version
...
shell.run("/startup")
print "Done. :D"
print "(It is recommended to run 'cc-paw install cc-paw-installer' to get a copy of the installer script for recovering from CC-PAW issues.)"
